    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            if (command.equals("points")) {
                ...
                System.out.println("Top 10 Players by Assists");
                NHLStatistics.sortByAssists();
                NHLStatistics.top(10);
            } else if (command.equals("penalties")) {
                //  Print the top ten players sorted by penalties.
                System.out.println("Top 10 Players by Penalties");
                ...
                System.out.println("Stats of " + player);
                ...
                System.out.println("Which club's stats would you like to see?");
                String club = reader.nextLine();
                System.out.println("Top 10 Club Player's by Points");
                NHLStatistics.sortByPoints();
